/**
 * Test Sanity Connection Script (JavaScript version)
 * Run this to verify your Sanity setup
 * 
 * Usage: node scripts/test-sanity.js
 */
...
async function testConnection() {
  ...
  try {
    ...
    if (allProjects.length === 0) {
      console.log('⚠️  No content found! You need to:');
      console.log('   1. Run the seed script, OR');
      console.log('   2. Add content manually in Sanity Studio\n');
      ...
      console.log('   Your homepage should now display featured projects.\n');
    }
    ...
    console.log('   4. Make sure you installed dotenv: npm install dotenv\n');
  }
}
